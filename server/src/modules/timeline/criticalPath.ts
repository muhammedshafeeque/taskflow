...
/**
 * Critical Path Method on a DAG of tasks. Durations derived from start/end dates.
 * Returns tasks with zero slack on the longest path.
 */
...
export function isoDate(d: Date | undefined | null): string | undefined {
  if (!d) return undefined;
  return dayKey(d instanceof Date ? d : new Date(d));
}
